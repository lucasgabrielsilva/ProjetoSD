...
class Player (val socket: Socket) : Thread() {
    ...
    fun setNickName(state: Boolean){
        ...
        this.nickName = messageIn.nextLine().toUpperCase()
    }
    ...
    fun getCharacter(): String{
        ...
        return messageIn.nextLine().toUpperCase()
    }
